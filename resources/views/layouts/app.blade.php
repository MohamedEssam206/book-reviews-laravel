...
<head>
    ...
    <style type="text/tailwindcss">
        .btn {
            @apply bg-white rounded-md px-4 py-2 text-center font-medium text-blue-400 shadow-sm ring-1 ring-slate-700/10 hover:bg-slate-50 h-10;
        }
...
@if(session()->has('success'))
    <div x-show="flash"
        ...
        <strong class="fonr-bold">Succsess</strong>
